...
kubectl exec -n thammphi -it test-pod -- cp /data/philipp/exp_shtest_trace_run /data/auto_reports_traces/
kubectl exec -n thammphi -it test-pod -- cp /data/philipp/exp_shtest_report.html /data/auto_reports_traces/
