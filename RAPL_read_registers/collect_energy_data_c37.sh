...
do
    ...
    #cat /energy-data/node-c37/intel-rapl:0/intel-rapl:0:0/energy_uj >> $filename #only CPU cores
    cat /energy-data/node-c37/intel-rapl:0/energy_uj >> $filename #package
    (date +"%H:%M:%S.%3N") >> $filename
    cat /energy-data/node-c37/intel-rapl:0/intel-rapl:0:0/energy_uj >> $filename2 #DRAM
